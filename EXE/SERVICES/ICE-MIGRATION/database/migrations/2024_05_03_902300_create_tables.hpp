    ...
    struct CreateTables : Migration
    {
        ...
        void up() const override
        {
            Schema::create("auditorium", [](Blueprint &table)
            {
                ...
                table.string("ip_ims", 45); /* Varchar(45) */
                table.integer("port_ims");
                table.string("user_ims", 45); /* Varchar(45) */
                table.string("pass_ims", 45); /* Varchar(45) */
            ...
            {
                table.id().from(4); /* AUTO_INCREMENT */
                table.string("uuid", 45); /* Varchar(45) */
                table.string("name", 200); /* max 255 */
                table.integer("type_cpl"); 
                table.string("sha1_sync", 40); /* Varchar(45) */
                table.string("path_cpl", 200); /* max 255 */
                table.string("path_sync", 200).nullable(); /* max 255 */
            ...
            Schema::create("release", [](Blueprint &table)
            {
                ...
                table.string("global_pattern", 45); /* Varchar(45) */
                table.string("specific_pattern", 45); /* Varchar(45) */
            ...
            Schema::create("release_cut", [](Blueprint &table)
            {
                table.id().from(4); /* AUTO_INCREMENT */
                table.integer("id_release");
                table.string("decription", 200).nullable(); /* max 255 */
            ...
            Schema::create("script", [](Blueprint &table)
            {
                table.id().from(4); /* AUTO_INCREMENT */
                table.string("name", 45); /* Varchar(45) */
                table.string("path", 200); /* max 255 */
                table.string("cis_name", 45); /* Varchar(45) */
                table.string("lvi_name", 45); /* Varchar(45) */
                table.integer("type");
                table.string("version", 45); /* Varchar(45) */
                table.string("sha1Lvi", 40); /* Varchar(45) */

            });
            Schema::create("server", [](Blueprint &table)
            {
                table.id().from(7); /* AUTO_INCREMENT */
