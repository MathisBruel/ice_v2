...
Query* MySQLReleaseRepo::MySQLcreate(Releases* release)
{
    ...
    createQuery->addParameter("id_movie", &_releaseIds[0], "int");
...
Query* MySQLReleaseRepo::MySQLread(Releases* release)
{
    ...
    if (*&_releaseIds[0] != -1 ) {readQuery->addWhereParameter("id_movie", &_releaseIds[0], "int");};
...
Query* MySQLReleaseRepo::MySQLremove(Releases* release)
{
    ...
    removeQuery->addWhereParameter("id_movie", &_releaseIds[0], "int");
