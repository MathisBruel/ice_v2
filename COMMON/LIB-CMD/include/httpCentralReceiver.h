...
class HttpCentralHandler : public Poco::Net::HTTPRequestHandler
{
...
class HttpCentralHandlerFactory : public Poco::Net::HTTPRequestHandlerFactory
{
public:
    HttpCentralHandlerFactory() {}

    Poco::Net::HTTPRequestHandler* createRequestHandler(const Poco::Net::HTTPServerRequest& request)
    {
        return new HttpCentralHandler();
    }
};